        ...
        [
            {
                ...
                textDesc: 'Язык германской ветви, на котором говорят в Норвегии. Исторически норвежский наиболее близок фарерскому и исландскому языкам, однако благодаря значительному влиянию датского языка и некоторому влиянию шведского, норвежский в общем близок также и этим языкам.'
            },
            {
                ...
                titleDesc: 'голландский язык (немецкий), de Nederlandse taal, het Nederlands',
                textDesc: 'Нидерландский язык часто называют голландским или фламандским. Правильнее говорить, что данные названия относятся к соответствующим группам диалектов'
            },
            {
                language: 'Английский',
                id: 2,
                ...
                textDesc: 'язык англо-фризской подгруппы западной группы германской ветви индоевропейской языковой семьи. Английский язык — важнейший международный язык[5], что является следствием колониальной политики Британской империи в XIX веке и мирового влияния США в XX—XXI веках.'
            },
            {
                language: 'Венгерский ',
                id: 3,
                ...
                titleDesc: 'magyar, magyar nyelv, устаревшее название — мадья́рский язык',
                textDesc: 'Язык венгров, принадлежащий к финно-угорской семье языков (уральские языки), внутри которой он, вместе с мансийским и хантыйским языками, составляет угорскую группу.'
            },
            {
                ...
                textDesc: 'Официальный язык Италии, Ватикана (наряду с латинским), Сан-Марино и Швейцарии (наряду с немецким, французским и ретороманским). Признан вторым официальным языком в нескольких округах Хорватии и Словении.'
            },
            {
                language: 'Шведский',
                id: 5,
                ...
                titleDesc: 'svenska',
                textDesc: 'Язык восточной подгруппы скандинавской группы, на котором говорят в Швеции, части Финляндии и на автономных Аландских островах. Самый распространённый язык Скандинавии с числом носителей, превосходящим девять миллионов.'
            },
        ],
        [
            {
                ...
                titleDesc: 'বাংলা',
                textDesc: 'язык бенгальцев, один из языков индоарийской ветви индоевропейской языковой семьи. Распространён в Бангладеш и индийском штате Западная Бенгалия, кроме того, носители языка живут в индийских штатах Трипура, Ассам и Андаманские и Никобарские острова. Общее число говорящих на бенгали — около 250 млн человек (2009).'
            },
            {
                language: 'Кантонский',
                id: 1,
                ...
                textDesc: 'Один из китайских диалектов; один из юэских говоров, появившийся в Кантоне (французское название Гуанчжоу). Является престижным наречием юэского языка.'
            },
            {
                language: 'Китайский',
                id: 2,
            ...
            },
            {
                ...
                titleDesc: 'اردو',
                textDesc: 'Язык индоевропейской семьи индоарийской группы; функциональный стиль языка хиндустани, на разговорном уровне взаимопонятный с хинди, возникший в XIII веке.'
            },
            {
                language: 'Малайский',
                id: 4,
                ...
                textDesc: 'Один из австронезийских языков (малайско-полинезийская ветвь, западная «подветвь»). В 1970—1990 годах в Малайзии использовалось также название малайзи́йский язы́к.'
            },
            {
                ...
                textDesc: 'Язык туркмен, относящийся к огузской группе тюркских языков. Территориально сосредоточен в Туркмении, а также в Иране, Афганистане, Турции, Таджикистане, Казахстане, Узбекистане и России.'
            }
        ],
        [
            {
                ...
                textDesc: 'Один из германских языков (до начала XX века считался диалектом нидерландского), один из 11 официальных языков Южно-Африканской Республики, также распространён в Намибии.'
            },
            {
                language: 'Ара́бский',
                id: 1,
                ...
                textDesc: 'язык семитской семьи афразийской макросемьи языков. Число говорящих на арабском языке и его вариантах составляет около 240 миллионов (родной язык), и ещё около 50 миллионов человек использует арабский в качестве второго языка.'
            },
            {
                language: 'Французский',
                id: 2,
                ...
                textDesc: 'Один из официальных языков франкоязычного населения Бельгии, Швейцарии (главным образом в Романдии) и Канады (главным образом в Квебеке). Французским языком пользуется население многих государств Африки, Карибского бассейна (Гаити и другие), Французской Гвианы, в том числе и в качестве официального языка.'
            },
            {
                ...
                textDesc: 'Континуум взаимопонятных разновидностей арабского языка, сложившихся на основе бедуинского диалекта и распространённых в Ираке, а также в Сирии, Иране, Юго-Восточной Турции и среди представителей иракской диаспоры за рубежом. Общее число носителей — 15,1 млн человек (из них 11,5 млн в Ираке).'
            },
            {
                ...
                textDesc: 'Язык романской группы индоевропейской семьи языков, иберо-романская подгруппа. Развился из средневекового галисийско-португальского языка.'
            },
            {
                language: 'Испанский',
                id: 5,
                ...
                textDesc: 'Плюрицентрический иберо-романский язык, зародившийся в средневековом королевстве Кастилия, которое включало в себя современную территорию провинции Бургос и автономных областей Ла-Риоха и Кантабрия, и широко распространившийся в других регионах мира в эпоху Великих географических открытий.'
            }
        ],
        [
            {
            ...
            },
            {
                ...
                titleDesc: 'Quenya',
                textDesc: ' искусственный язык, разработанный Дж. Р. Р. Толкином. В легендариуме представляет собой один из эльфийских языков — речь нолдор и ваньяр. Слово «квенья» переводится как «наречие, язык» или, в противоположность другим языкам, «эльфийское наречие, эльфийский язык».'
            },
            {
                ...
                textDesc: 'Искусственный язык, разработанный лингвистом Марком Окрандом по заказу Paramount Studios для одной из инопланетных рас в вымышленной вселенной сериала «Звёздный путь». В отличие от многих языков, созданных для кинематографа, клингонский язык имеет детально разработанную грамматику, синтаксис и словарь,'
            },
            {
            ...
            },
            {
                ...
                titleDesc: 'Двоичный',
                textDesc: 'Также известный как язык дроидов — компьютерный язык дроидов, состоявший из электронных биканий, трелей, писков и свистков. Все дроиды могли «говорить» или понимать двоичный.'
            }
        ],
    ],
...
export default (state = initialState, action) => {
    switch (action.type) {
        ...
        case CLICK_NEXT_LEVEL:
            ...
            state.randomQuestionNumber = Math.floor(Math.random() * state.dataLanguage[state.level].length);
            return state;
        case NEW_GAME:
            state.isGuessed = false;
            state.score = 5;
            ...
            state.dataLanguage.map(n => n.map(s => {
                s.isSelected = false;
                s.pinColorWin = false;
                return s;
            } ))
